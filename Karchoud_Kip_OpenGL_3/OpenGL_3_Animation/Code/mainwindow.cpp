...
void MainView::initWorld()
{
    ...
    transformationsObj5 = {0,0,-10,0,0,0};

    //animation values
    moveObj1 = {0,0,3.5,0,0,0};       //car
    moveObj2 = {0,0,2.5,0,0,0};       //rocket
    moveObj3 = {0,0,0,0,0,0};         //earth
    moveObj4 = {0,0,5.5,0,0,0};         //earth.moon
    moveObj5 = {0,0,7,0,0,0};
...
void MainView::paintGL() {
    ...
    moveObjects(obj4Transform, moveObj4);
    moveObjects(obj5Transform, moveObj5);
